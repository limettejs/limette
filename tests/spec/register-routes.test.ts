...
describe('runtime route definitions', () => {
  it('preserves supplied route and middleware order and validates modules', async () => {
    const calls: string[] = [];
  ...
  it('coexists with imperative routes and rejects duplicates', async () => {
  ...
  it('renders precomputed layouts, islands, and route assets', async () => {
